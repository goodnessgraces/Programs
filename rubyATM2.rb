def atm_action(balance,action)
	case :action
	when "1"
		puts "Please enter the amount you wish to withdrawl:"
		amount = gets.chomp.to_f
		if balance - amount < 0
			puts "Sorry, you don't hace that much money"
		else
...
puts "Welcome to the Ruby ATM. Please enter your initial balance:"
